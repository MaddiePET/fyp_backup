...
export default function PersonalNonMalaysianInfo() {
  ...
  const [formData, setFormData] = useState({
    ...
    nationality: "British",
    issueDate: "1 January 2011",
    expiryDate: "1 January 2021",
  });

  const handleNavigation = () => router.push('/personal_non_malaysian_address');
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen px-4 py-20 bg-[#F9FAFB] dark:bg-gray-950 overflow-hidden">
      ...
      <div className="absolute top-6 left-4 right-4 flex justify-between items-center max-w-7xl mx-auto w-full z-20">
        <button
          type="button" 
          onClick={() => router.push('/personal_non_malaysian_passport')}
