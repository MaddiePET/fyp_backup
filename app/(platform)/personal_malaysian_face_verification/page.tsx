  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen px-4 py-20 bg-[#F9FAFB] dark:bg-gray-950 overflow-hidden">
      ...
      <div className="absolute top-6 left-4 right-4 flex justify-between items-center max-w-7xl mx-auto w-full z-20">
        <button onClick={() => router.push("/personal_malaysian_mailing_address")} className="inline-flex items-center text-sm text-gray-500 transition-colors hover:text-[#3D405B] dark:text-gray-400 dark:hover:text-white">
      ...
      <div className="relative w-full max-w-md animate-in fade-in duration-500 z-10">
        ...
        <div className="space-y-3 relative z-10">
          ...
          {status === "success" && (
            <>
              <button onClick={() => router.push("/personal_malaysian_application")} className="inline-flex items-center justify-center w-full px-4 py-3 text-sm font-bold transition rounded-lg shadow-theme-xs relative z-10 bg-[#3D405B] text-white hover:bg-[#2c2f42] dark:bg-[#3D405B] dark:hover:bg-[#4a4e6d]">
                Continue
              </button>
