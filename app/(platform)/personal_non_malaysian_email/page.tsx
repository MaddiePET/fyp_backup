...
export default function PersonalNonMalaysianEmail() {
  ...
  const handleGlobalBack = () => {
    ...
    else router.push("/personal_non_malaysian_address");
  };
  ...
  const handleVerifyOtp = () => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      router.push("/personal_non_malaysian_phone");
    }, 800);
  };
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen px-4 py-20 bg-[#F9FAFB] dark:bg-gray-950 overflow-hidden">
      ...
      <div className="absolute top-6 left-4 right-4 flex justify-between items-center max-w-7xl mx-auto w-full z-20">
        <button onClick={handleGlobalBack} className="inline-flex items-center text-sm text-gray-500 transition-colors hover:text-[#3D405B] dark:text-gray-400 dark:hover:text-white">
          ...
          <div className="animate-in fade-in duration-500">
            ...
            <form onSubmit={handleSendOtp} className="space-y-6">
              <div>
                ...
                <input type="email" required placeholder="name@example.com" className="w-full px-4 py-3 text-sm font-medium transition-all border-2 rounded-lg outline-none border-gray-200 bg-white focus:border-[#3D405B] focus:ring-4 focus:ring-[#3D405B]/10 dark:bg-gray-900 dark:border-gray-800 dark:text-white dark:focus:border-[#5c6185] dark:focus:ring-[#3D405B]/40" value={email} onChange={(e) => setEmail(e.target.value)} />
              </div>
