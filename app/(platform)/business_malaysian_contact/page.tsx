...
export default function BusinessMalaysianContact() {
  ...
  const handleVerify = () => {
    if (step === "email-otp") {
      ...
      setIsLoading(true);
      setTimeout(() => {
         router.push("/business_malaysian_face_verification");
      }, 800);
    }
  };
    ...
    <div className="relative flex flex-col items-center justify-center min-h-screen px-4 py-20 bg-[#F9FAFB] dark:bg-gray-950 overflow-hidden">
      ...
      <div className="absolute top-6 left-4 right-4 flex justify-between items-center max-w-7xl mx-auto w-full z-20">
        ...
        <div className="flex items-center">
          ...
          <h1 className="font-semibold text-gray-800 text-title-sm dark:text-white/90 uppercase tracking-tight whitespace-nowrap">DTCOB</h1>
        </div>
      </div>
      ...
      <div className="relative w-full max-w-md z-10">
        ...
        {step === "details" && (
          <div className="animate-in fade-in duration-500">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="flex mt-2">
                    ...
                    <input
                      className="w-full px-4 py-3 text-sm font-medium transition-all border-2 rounded-lg outline-none border-gray-200 bg-white focus:border-[#3D405B] focus:ring-4 focus:ring-[#3D405B]/10 dark:bg-gray-900 dark:border-gray-800 dark:text-white dark:focus:border-[#5c6185] dark:focus:ring-[#3D405B]/40 rounded-l-none"
            ...
            <div className="mt-8 p-4 rounded-xl flex gap-3 border transition-all bg-blue-50 border-blue-200 dark:bg-blue-900/30 dark:border-blue-500/50">
        ...
        {step === "email-otp" && (
          <div className="animate-in fade-in duration-500">
            ...
            <div className="mt-8 p-4 rounded-xl flex gap-3 border transition-all bg-blue-50 border-blue-200 dark:bg-blue-900/30 dark:border-blue-500/50">
              ...
              <p className="text-xs leading-relaxed text-blue-900 dark:text-blue-100">
                <span>Standard email rates may apply. Your email address is used solely for secure account registration and <span className="font-bold text-blue-700 dark:text-blue-300">identity verification</span>.</span>
              </p>
            </div>
          </div>
        )}
        ...
        {step === "phone-otp" && (
          <div className="animate-in fade-in duration-500">
            ...
            <div className="mt-8 p-4 rounded-xl flex gap-3 border transition-all bg-blue-50 border-blue-200 dark:bg-blue-900/30 dark:border-blue-500/50">
              ...
              <p className="text-xs leading-relaxed text-blue-900 dark:text-blue-100">
                <span>Standard SMS rates may apply. Your mobile number is used solely for secure account registration and <span className="font-bold text-blue-700 dark:text-blue-300">identity verification</span>.</span>
              </p>
            </div>
          </div>
        )}
